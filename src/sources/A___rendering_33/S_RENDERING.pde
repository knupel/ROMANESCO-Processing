...
void rendering_item_3D(boolean use_layer_is, int index) {
	if(use_layer_is) {
		get_layer(index);
		begin_layer();
...
void rendering_item_2D(boolean use_layer_is, int index) {
	if(use_layer_is) {
		get_layer(index);
		begin_layer();
...
void rendering_info(boolean use_layer_is, int index) {
	if(use_layer_is) {
		get_layer(index);
		begin_layer();
		info();
