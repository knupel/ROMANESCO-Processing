...
class SpiraleRomanesco extends SuperRomanesco {
  ...
  public void display() {
    ...
    float z = map(amplitudeObj[IDobj], 1,height,1.01f, ratio)  ;
    //speed
...
public void backgroundShaderDraw(boolean renderP3D, int whichShader) {
  if(renderP3D) {
...
public PVector calculPos(PVector origin,  PVector finish, float speed) {
...
//ANNEXE LIGHT VOID
public void romanescoLight(PVector colorOne, PVector colorTwo, PVector dir) {
