...
public class Scene_24u extends PApplet {
...
class RomanescoTwo extends SuperRomanesco 
{
  ...
  public void display() {
    ...
    // if (romanescoEmptyList(IDobj)) creatureManager.killAll();
...
//MOUSEPRESSED
public void romanescoFortyThreeMousepressed() { romanescoFortyThree.mousepressed() ; }
//MOUSERELEASED
public void romanescoFortyThreeMousereleased() { romanescoFortyThree.mousereleased() ; }
//MOUSE DRAGGED
public void romanescoFortyThreeMousedragged() { romanescoFortyThree.mousedragged() ; }
//KEYPRESSED
public void romanescoFortyThreeKeypressed() { romanescoFortyThree.keypressed() ; }
//KEY RELEASED
public void romanescoFortyThreeKeyreleased() { romanescoFortyThree.keyreleased() ; }
...
class Pixel
{
  ...
  public void changeColor(int nc) { int c = nc ; }
...
public String nameNumber(String name) 
{
  ...
  return numPict = (name + newYear + "_" + newMonth + "_" + newDay + "_" +newSecond) ;
}
//END TRANSLATOR
////////////////
...
public void oscEvent(OscMessage receive ) {
  ...
  valueButtonObj = PApplet.parseInt(split(dataPreScene[1], '/')) ;
  valueButtonTex = PApplet.parseInt(split(dataPreScene[2], '/')) ;
  valueButtonTypo = PApplet.parseInt(split(dataPreScene[3], '/')) ;
...
//Un grand Merci \u00e0 Laetitia, ma femme pour son soutient pendant toutes ses semaines de d\u00e9veloppement

// Un Grand merci \u00e9galement \u00e0 la communaut\u00e9 Processing : 
// Daniel Shiffman for the slider, 
// Marius Waltz pour Reads RSS et Atom feeds, 
// Philo pour les conseils via le Forum, 
// Andres Colubri for the sender Syphon
// Mark webster et ses workshop.
// Agnes de Mains d'\u0152uvre \u00e0 Saint-Ouen
// Ivan sans lequel je n'aurais pas connu Processing
...
public void romanescoKeyreleased() { 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Scene_24u" };
    if (passedArgs != null) {
