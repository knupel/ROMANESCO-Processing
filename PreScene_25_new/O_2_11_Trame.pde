...
class Damier extends SuperRomanesco {
  ...
  void display() {
    ...
    //MODE DISPLAY
    if(modeButton[IDobj] == 0 || modeButton[IDobj] == 255) trame.drawTrameRect(mouse[IDobj], angleTrame, angle, size , q, fillObj[IDobj], strokeObj[IDobj], thicknessObj[IDobj], g, d, amp) ;
    else if (modeButton[IDobj] == 1) trame.drawTrameDisc(mouse[IDobj], angleTrame, angle, size , q, fillObj[IDobj], strokeObj[IDobj], thicknessObj[IDobj], g, d, amp) ;
    else if (modeButton[IDobj] == 2) trame.drawTrameBox(mouse[IDobj], angleTrame, angle, size , q, fillObj[IDobj], strokeObj[IDobj], thicknessObj[IDobj], g, d, amp) ;
