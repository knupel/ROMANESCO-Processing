...
int NUM_BUTTON_GENERAL = NUM_BUTTON_CURTAIN + NUM_BUTTON_BACKGROUND + NUM_BUTTON_LIGHT +NUM_BUTTON_TRANSIENT;
...
int NUM_MOLETTE_BACKGROUND = 9;
int NUM_MOLETTE_FILTER = 12;
int NUM_MOLETTE_LIGHT = 9;
int NUM_MOLETTE_SOUND = 2;
int NUM_MOLETTE_SOUND_SETTING = 11; // 11
int NUM_MOLETTE_CAMERA = 7;
