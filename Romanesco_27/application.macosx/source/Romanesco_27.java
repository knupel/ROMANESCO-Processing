...
public class Romanesco_27 extends PApplet {
...
public void launcherDraw() {
  ...
  rect(0,30,width,2) ;
  fill(blanc) ;
  text(nameVersion, 10.0f, 23.0f);
  textFont(EmigreEight,14);
  text("Version " +prettyVersion + "."+version, 205.0f, 23.0f);
  fill(grisClair) ;
  textFont(FuturaStencil,20);
...
class Slider
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Romanesco_27" };
    if (passedArgs != null) {
