...
class LesVieux extends SuperRomanesco {
  public LesVieux() {
    ...
    romanescoSlider = "Hue fill,Saturation fill,Brightness fill,Alpha fill,Hue stroke,Saturation stroke,Brightness stroke,Alpha stroke,Thickness,Canvas X,Speed,Amplitude,Alignment" ;
  }
  //GLOBAL
  ...
  float speedCurve ;
  void courbe() {
    float bezierPoint = map(alignmentObj[IDobj],0,1,1,100) *beat[IDobj] ;
