...
class Atome extends SuperRomanesco {
  ...
  public void display() {
    ...
    if(atomList.size()<1) {
      int num = PApplet.parseInt(random(1,quantityObj[IDobj]*3)) ;
      for(int i = 0 ; i < num ; i++ ) {
...
class SpiraleRomanesco extends SuperRomanesco {
  ...
  public void display() {
    ...
    int n ;
    int nMax = 1 ;
    if(fullRendering) nMax = 1 + (int)quantityObj[IDobj] *3 ; else nMax = 1 + PApplet.parseInt(quantityObj[IDobj] *.5f) ;
    n = nMax ;
...
class Galaxie extends SuperRomanesco {
  ...
  public void display() {
    ...
    //quantity of star
    if (mode[IDobj] == 0 ) numFromControler = PApplet.parseInt(9*(sq(quantityObj[IDobj])) ) ; else numFromControler = 30 + PApplet.parseInt(25 *quantityObj[IDobj]) ;
    if(fullRendering ) {
      if (mode[IDobj] == 0 ) numFromControler = PApplet.parseInt(9*(sq(quantityObj[IDobj])) ) ; else numFromControler = 30 + PApplet.parseInt(25 *quantityObj[IDobj]) ;
    } else {
      if (mode[IDobj] == 0 ) numFromControler = PApplet.parseInt(9*quantityObj[IDobj]) ; else numFromControler = 30 + PApplet.parseInt(quantityObj[IDobj]) ;
    }
    ...
    if(motion[IDobj]) speedDust = map(speedObj[IDobj],0,1, 0.00005f ,0.5f) ; else speedDust = 0.00001f ;
...
class Honeycomb extends SuperRomanesco {
  ...
  public void display() {
    ...
    if(fullRendering) {
      ...
      //change the radius of hexagon
      hexagonRadius = map(sizeXObj[IDobj],.1f,width, 20, width/15)  ;
    }
