...
//SETUP
void romanescoTwentySevenSetup() {
...
//DRAW
void romanescoTwentySevenDraw(String [] dataControleur, String [] dataMinim) {
...
//MOUSEPRESSED
void romanescoTwentySevenMousepressed() { romanescoTwentySeven.mousepressed() ; }
//MOUSERELEASED
void romanescoTwentySevenMousereleased() { romanescoTwentySeven.mousereleased() ; }
//MOUSE DRAGGED
void romanescoTwentySevenMousedragged() { romanescoTwentySeven.mousedragged() ; }
//KEYPRESSED
void romanescoTwentySevenKeypressed() { romanescoTwentySeven.keypressed() ; }
//KEY RELEASED
void romanescoTwentySevenKeyreleased() { romanescoTwentySeven.keyreleased() ; }

//Return the ID familly to choice the data must be send to the class // 0 is global // 1 is Object // 2 is trame // 3 is typo
int getFamillyRomanescoTwentySeven() { return romanescoTwentySeven.getIDfamilly() ; }
...
class RomanescoTwentySeven extends SuperRomanesco 
{
  ...
  void display() {
    ...
    //update position
     ...
     objMotion = int(map(valueObj[IDobj][26],0,100, 0,20) *(1.0 + pen[IDobj].z)) ;
    ...
    int n = int(map(valueObj[IDobj][14],0,100,4,50)) ;
    ...
    radiusAnalyze = int(map(valueObj[IDobj][17],0,100,2,100));
    pixelAnalyzeSize = int(map(valueObj[IDobj][28],0,100,2,30));
